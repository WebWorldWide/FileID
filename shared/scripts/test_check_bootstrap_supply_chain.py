...
class BootstrapSupplyChainTests(unittest.TestCase):
    ...
    def test_reviewed_shell_script_inventory_is_exact(self) -> None:
        self.assertEqual(REVIEWED_SHELL_SCRIPT_SHA256, {
            ...
            "platforms/apple/scripts/build_dmg.sh": "7b7a3b19401ad22f095b94c6bb464829784d61787c445bf8966920906893fdb9",
            ...
            "platforms/apple/scripts/release.sh": "1facce1c7d23a5ddf643e191172e77f0be1023ed6a2a19cc8e432d21dd14e38a",
