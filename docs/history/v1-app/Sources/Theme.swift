...
// Gold, right-aligned toggle row. All in-app switches route through this so
// they never regress back to stock-blue/floating layout.
...
// .pickerStyle(.segmented) renders light and clashes with the gold-on-dark theme.
